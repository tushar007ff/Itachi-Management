...
import RudraRobot.modules.sql.global_bans_sql as gban_sql
import RudraRobot.modules.sql.users_sql as user_sql
from RudraRobot import DEV_USERS, OWNER_ID, dispatcher
