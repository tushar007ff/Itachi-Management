...
# from RudraRobot.modules.sql import warns_sql as warnssql
import RudraRobot.modules.sql.blacklist_sql as blacklistsql

# from RudraRobot.modules.sql import cust_filters_sql as filtersql
# import RudraRobot.modules.sql.welcome_sql as welcsql
import RudraRobot.modules.sql.locks_sql as locksql
import RudraRobot.modules.sql.notes_sql as sql

# from RudraRobot.modules.rules import get_rules
import RudraRobot.modules.sql.rules_sql as rulessql
from RudraRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from RudraRobot.__main__ import DATA_IMPORT
from RudraRobot.modules.connection import connected
from RudraRobot.modules.helper_funcs.alternate import typing_action
from RudraRobot.modules.helper_funcs.chat_status import user_admin
from RudraRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("RudraRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("RudraRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `RudraRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("RudraRobot{}.backup".format(chat_id))  # Cleaning file
