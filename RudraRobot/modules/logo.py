...
from RudraRobot.modules.nightmode import button_row
from RudraRobot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from RudraRobot.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./RudraRobot/resources/fonts/*")
